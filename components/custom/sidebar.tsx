...
const SidebarNav = () => {
    return (
        <div>
            <aside className="inset-y fixed  left-0 z-20 flex h-full flex-col border-r bg-[#192339] text-white">
                ...
                <nav className="grid gap-1 p-2">
                    ...
                    {/* Prompt collection for AI Product */}
                    <TooltipProvider>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Link href="/seo">
                            ...
                            <TooltipContent side="right" sideOffset={5}>
                                Prompt Collection for AI Product Shots
                            </TooltipContent>
                        </Tooltip>
                    </TooltipProvider>
                    {/* Prompt collection for AI Food */}
                    <TooltipProvider>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Link href="/seo">
                            ...
                            <TooltipContent side="right" sideOffset={5}>
                                Prompt Collection for AI Food Shots
                            </TooltipContent>
                        </Tooltip>
                    </TooltipProvider>
                </nav>
